...
1.	A .csv file of cleaned data with 2 columns: Date, X (feature X can be any arbitrary numerical value)
2.	A .csv file of predictions for feature X fitted on the .csv file from 1.
o	Multiple .csv files can be exist (e.g. different seeds of a model)
...
The following libraries are required for this report generator:
•	Numpy
•	Pandas
•	Matplotlib
•	Scipy
